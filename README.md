...
The methods described in this section use `MyEnum` as a placeholder name for the actual enum type generated by GoEnum

`func (me MyEnum) Name() string` - Returns the name of the variant as a string.

`func (me MyEnum) String() string` - Returns the given `--string` value of the variant. If none has been set, its return value is as though `Name()` had been called.

`func (me MyEnum) Description() string` - Returns the given `--description` value of the variant. If None has been set, its return value is as though `String()` had been called.

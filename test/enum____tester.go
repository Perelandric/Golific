...
type FooEnum struct{ value_1ig3rpjj9z29z uint8 }
...
var Foo = struct {
	...
	Bar: FooEnum{value_1ig3rpjj9z29z: 1},
	Baz: FooEnum{value_1ig3rpjj9z29z: 2},
	Buz: FooEnum{value_1ig3rpjj9z29z: 3},
}
...
func (Fe *FooEnum) UnmarshalJSON(b []byte) error {
	...
	switch s {
	case "bar":
		Fe.value_1ig3rpjj9z29z = 1
		return nil
	case "baz":
		Fe.value_1ig3rpjj9z29z = 2
		return nil
	case "Buz":
		Fe.value_1ig3rpjj9z29z = 3
		return nil
	default:
...
type OofEnum struct{ value_3j00ucqbi20s uint8 }
...
var Oof = struct {
	...
	Bar: OofEnum{value_3j00ucqbi20s: 1},
	Baz: OofEnum{value_3j00ucqbi20s: 123},
	Buz: OofEnum{value_3j00ucqbi20s: 3},
}
...
func (Oe OofEnum) Value() uint8 {
	return Oe.value_3j00ucqbi20s
}

// IntValue is the same as 'Value()', except that the value is cast to an 'int'.
func (Oe OofEnum) IntValue() int {
	return int(Oe.value_3j00ucqbi20s)
}

// Name returns the name of the variant as a string.
func (Oe OofEnum) Name() string {
	switch Oe.value_3j00ucqbi20s {
	case 1:
		return "Bar"
	case 123:
		return "Baz"
...
type AnimalEnum struct{ value_zz12z90c5d54 uint8 }
...
var Animal = struct {
	...
	Dog:   AnimalEnum{value_zz12z90c5d54: 1},
	Cat:   AnimalEnum{value_zz12z90c5d54: 2},
	Horse: AnimalEnum{value_zz12z90c5d54: 3},
}
...
func (Ae AnimalEnum) Value() uint8 {
	return Ae.value_zz12z90c5d54
}

// IntValue is the same as 'Value()', except that the value is cast to an 'int'.
func (Ae AnimalEnum) IntValue() int {
	return int(Ae.value_zz12z90c5d54)
}

// Name returns the name of the variant as a string.
func (Ae AnimalEnum) Name() string {
	switch Ae.value_zz12z90c5d54 {
	case 1:
		return "Dog"
	case 2:
		return "Cat"
...
func (Ae *AnimalEnum) UnmarshalJSON(b []byte) error {
	...
	switch s {
	case "doggy":
		Ae.value_zz12z90c5d54 = 1
		return nil
	case "kitty":
		Ae.value_zz12z90c5d54 = 2
		return nil
	case "horsie":
		Ae.value_zz12z90c5d54 = 3
		return nil
	default:

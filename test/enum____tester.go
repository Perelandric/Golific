...
type FooEnum struct{ value_1s5osv4q5zhgo uint8 }
...
var Foo = struct {
	...
	Bar: FooEnum{value_1s5osv4q5zhgo: 1},
	Baz: FooEnum{value_1s5osv4q5zhgo: 2},
	Buz: FooEnum{value_1s5osv4q5zhgo: 4},
}
...
func (Fe FooEnum) String() string {
	...
	for _, item := range Foo.foobar {
		if Fe.value_1s5osv4q5zhgo&item.value_1s5osv4q5zhgo == item.value_1s5osv4q5zhgo {
...
func (Fe *FooEnum) UnmarshalJSON(b []byte) error {
	...
	switch s {
	case "bar":
		Fe.value_1s5osv4q5zhgo = 1
		return nil
	case "baz":
		Fe.value_1s5osv4q5zhgo = 2
		return nil
	case "Buz":
		Fe.value_1s5osv4q5zhgo = 4
		return nil
	}
	...
	Fe.value_1s5osv4q5zhgo = uint8(val)
	return nil
}
...
func (Fe FooEnum) Add(v FooEnum) FooEnum {
	Fe.value_1s5osv4q5zhgo |= v.value_1s5osv4q5zhgo
	return Fe
}
...
func (Fe FooEnum) AddAll(v ...FooEnum) FooEnum {
	for _, item := range v {
		Fe.value_1s5osv4q5zhgo |= item.value_1s5osv4q5zhgo
	}
	return Fe
}
...
func (Fe FooEnum) Has(v FooEnum) bool {
	return Fe.value_1s5osv4q5zhgo&v.value_1s5osv4q5zhgo == v.value_1s5osv4q5zhgo
}
...
type OofEnum struct{ value_1o9h6acy6sit1 uint8 }
...
var Oof = struct {
	...
	Bar: OofEnum{value_1o9h6acy6sit1: 1},
	Baz: OofEnum{value_1o9h6acy6sit1: 123},
	Buz: OofEnum{value_1o9h6acy6sit1: 3},
}
...
func (Oe OofEnum) Value() uint8 {
	return Oe.value_1o9h6acy6sit1
}

// IntValue is the same as 'Value()', except that the value is cast to an 'int'.
func (Oe OofEnum) IntValue() int {
	return int(Oe.value_1o9h6acy6sit1)
}

// Name returns the name of the variant as a string.
func (Oe OofEnum) Name() string {
	switch Oe.value_1o9h6acy6sit1 {
	case 1:
		return "Bar"
	case 123:
		return "Baz"
...
func (Oe *OofEnum) UnmarshalJSON(b []byte) error {
	...
	Oe.value_1o9h6acy6sit1 = uint8(n)
	return nil
}
...
type AnimalEnum struct{ value_133sywywz0ssk uint8 }
...
var Animal = struct {
	...
	Dog:   AnimalEnum{value_133sywywz0ssk: 1},
	Cat:   AnimalEnum{value_133sywywz0ssk: 2},
	Horse: AnimalEnum{value_133sywywz0ssk: 3},
}
...
func (Ae AnimalEnum) Value() uint8 {
	return Ae.value_133sywywz0ssk
}

// IntValue is the same as 'Value()', except that the value is cast to an 'int'.
func (Ae AnimalEnum) IntValue() int {
	return int(Ae.value_133sywywz0ssk)
}

// Name returns the name of the variant as a string.
func (Ae AnimalEnum) Name() string {
	switch Ae.value_133sywywz0ssk {
	case 1:
		return "Dog"
	case 2:
		return "Cat"
...
func (Ae *AnimalEnum) UnmarshalJSON(b []byte) error {
	...
	switch s {
	case "doggy":
		Ae.value_133sywywz0ssk = 1
		return nil
	case "kitty":
		Ae.value_133sywywz0ssk = 2
		return nil
	case "horsie":
		Ae.value_133sywywz0ssk = 3
		return nil
	default:
